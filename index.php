...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <a href="views/login.php" class="book-a-table-btn scrollto d-none d-lg-flex">Login</a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            ...
            <p class="font-italic">
               Have a blissful time with coffee and delicious food
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Dine In</li>
              <li><i class="bi bi-check-circle"></i> Takeout</li>
              <li><i class="bi bi-check-circle"></i> Delivery</li>
            </ul>
            <p>
              In order to provide happiness to all, we value each and every customer and provide you with a comfortable space and a luxurious time. <br>
              I hope that as many customers as possible will know us. <br>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea enim recusandae, voluptas vel id cupiditate explicabo reprehenderit tempora velit in!
            </p>
          </div>
        </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-6 menu-item filter-specialty">
            <img src="assets/img/menu/hot-coffee.jpg" class="menu-img" alt="">
            <div class="menu-content">
              <a href="#">Hot Coffee</a><span>$3.5</span>
            </div>
            <div class="menu-ingredients">
              Plump lobster meat, mayo and crisp lettuce on a toasted bulky roll
            </div>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <form action="action/userAction.php" method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
          <div class="row">
            ...
            <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
              <input type="text" class="form-control" name="phone_number" id="phone" placeholder="Your Phone Number" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
              <div class="validate"></div>
            </div>
